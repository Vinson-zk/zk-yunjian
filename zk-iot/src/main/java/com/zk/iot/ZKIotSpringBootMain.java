...
* with ZK-Vinson. 
*
* @Title: ZKIotSpringBootMain.java 
* @author Vinson 
* @Package com.zk.iot 
* @Description: TODO(simple description this file what to do. ) 
* @date Dec 31, 2024 11:20:04 AM 
* @version V1.0 
*/
package com.zk.iot;
...
public class ZKIotSpringBootMain {

    protected static Logger log = LogManager.getLogger(ZKIotSpringBootMain.class);

    public static void main(String[] args) {
        try {
            log.info("[^_^:20241231-1410-001]========================================");
            log.info("[^_^:20241231-1410-001]=== zk iot  启动 ... ... ");
            log.info("[^_^:20241231-1410-001]========================================");
            run(args);
            log.info("[^_^:20241231-1410-001]----------------------------------------");
    ...
    public static ConfigurableApplicationContext run(String[] args) {
        ...
        springApplicationBuilder = springApplicationBuilder.sources(ZKIotSpringBootMain.class);
        ...
        // 隔；
        springApplicationBuilder = springApplicationBuilder.properties("spring.config.name=zk,zk.iot,zk.iot.env");
