...
public class ZKCustomParams implements Interceptor {
    ...
    private Object wrapCollection(ZKDBConfiguration zkConfiguration, String mappedStatementId, final Object parameter) {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if(configuration instanceof ZKDBConfiguration){
            Object parameter = objs[1];
            this.wrapCollection((ZKDBConfiguration)configuration, ms.getId(), parameter);
        }
