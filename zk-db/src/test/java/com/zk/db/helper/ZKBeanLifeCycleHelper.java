...
* with ZK-Vinson. 
*
* @Title: ZKBeanLifeCycleHelper.java 
* @author Vinson 
...
/**
 * @ClassName: ZKBeanLifeCycleHelper
 * @Description: TODO(simple description this class what to do. )
 * @author Vinson
 * @version 1.0
 */
//@Configuration
public class ZKBeanLifeCycleHelper implements //
    ...
    public ZKBeanLifeCycleHelper() {
        this.name = "ZKBeanLifeCycleHelper";
        this.print(" 1.", "构造方法;", null, allPrintName);
    }

    public ZKBeanLifeCycleHelper(String name) {
        this.name = name;
        this.print(" 1.", "构造方法;", null, allPrintName);
    }

// 配置 null 时，所有的都打印；不为 null 时，只打印设置的 bean 名称
    public List<String> printBeanNames = Arrays.asList("sqlSessionFactory", "zkDBProperties",
