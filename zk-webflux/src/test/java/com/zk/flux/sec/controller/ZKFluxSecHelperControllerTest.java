...
* with ZK-Vinson. 
*
* @Title: ZKFluxSecHelperControllerTest.java 
* @author Vinson 
* @Package com.zk.flux.sec.controller 
* @Description: TODO(simple description this file what to do. ) 
* @date Apr 16, 2024 1:15:19 AM 
* @version V1.0 
*/
package com.zk.flux.sec.controller;
...
import com.zk.flux.sec.helper.ZKFluxSecTestHelperSpringBootMain;
import com.zk.flux.sec.helper.controller.ZKFluxSecHelperController;
import com.zk.security.common.ZKSecConstants;

import junit.framework.TestCase;

/** 
* @ClassName: ZKFluxSecHelperControllerTest 
...
@SpringBootTest(classes = ZKFluxSecTestHelperSpringBootMain.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestPropertySource(locations = { "classpath:/" }, properties = { "spring.config.name=test.zk.sec" })
public class ZKFluxSecHelperControllerTest {
    ...
    private String privateUrlPath = "/flux/sec/h/c";
    ...
    public void testSecNone() {
        try {
            ...
            System.out.println("[^_^:20240422-2312-001] resStr: " + resStr);
            expectStr = ZKFluxSecHelperController.class.getName();
    ...
    private String login() {
        ...
        resStr = response.getBody();
        System.out.println("[^_^:20240422-2313-001] resStr: " + resStr);
...
//            requestEntity = new HttpEntity<>(requestBody, requestHeaders);
            ...
            response = testRestTemplate.postForEntity(this.baseUrl + this.privateUrlPath + urlPath, null, String.class);
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2313-002] resStr: " + resStr);
            expectStr = "not-login";
            TestCase.assertFalse(expectStr.equals(resStr));
        }
        catch(Exception e) {
    ...
    public void testSecLogout() {
        try {
            ...
            response = testRestTemplate.getForEntity(this.baseUrl + this.privateUrlPath + urlPath, String.class);
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2314-001] resStr: " + resStr);
            expectStr = "logout";
            TestCase.assertEquals(expectStr, resStr);
        }
        catch(Exception e) {
    ...
    public void testSecUser() {
        try {
            ...
            response = testRestTemplate.getForEntity(this.baseUrl + this.privateUrlPath + urlPath, String.class);
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2314-002.01] resStr: " + resStr);
            ...
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2314-002.02] resStr: " + resStr);
            expectStr = "user:admin";
            TestCase.assertEquals(expectStr, resStr);
            ...
            response = testRestTemplate.exchange(this.baseUrl + this.privateUrlPath + urlPath, HttpMethod.GET,
                    requestEntity, String.class);
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2314-002.03] resStr: " + resStr);
            expectStr = "user:admin";
            TestCase.assertEquals(expectStr, resStr);
    ...
    public void testSecZkSecApiCode() {
        try {
            ...
            response = testRestTemplate.getForEntity(this.baseUrl + this.privateUrlPath + urlPath, String.class);
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2315-004] resStr: " + resStr);
            ...
            response = testRestTemplate.getForEntity(this.baseUrl + this.privateUrlPath + urlPath, String.class);
            resStr = response.getBody();
            System.out.println("[^_^:20240422-2315-005] resStr: " + resStr);
            res = ZKJsonUtils.parseObject(resStr, ZKMsgRes.class);
