...
* with ZK-Vinson. 
*
* @Title: ZKWXThirdPartyMsgUtilsTest.java 
* @author Vinson 
* @Package com.zk.wechat.thirdParty.wx.thirdParty 
* @Description: TODO(simple description this file what to do. ) 
* @date Feb 18, 2021 3:30:38 PM 
* @version V1.0 
*/
...
/** 
* @ClassName: ZKWXThirdPartyMsgUtilsTest 
* @Description: TODO(simple description this class what to do. ) 
* @author Vinson 
* @version 1.0 
*/
public class ZKWXThirdPartyMsgUtilsTest {
    ...
    public void testGetDocumentMsg() {
        ...
        try {
            ...
            System.out.println(String.format(" appId: %s\n appSecret: %s\n token: %s\n aesKey: %s", appId, appSecret,
                    token, aesKey));
            System.out.println("-----------------------------");
            Document rootE = ZKWXThirdPartyMsgUtils.getDocumentMsg(token, aesKey, appId, encStr);
