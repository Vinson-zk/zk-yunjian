...
* with ZK-Vinson. 
*
* @Title: ZKWXTPAuthAccountAccessToken.java 
* @author Vinson 
 ...
 * 目标授权账号的 AccessToken
 * 
 * @ClassName: ZKWXTPAuthAccountAccessToken
 * @Description: TODO(simple description this class what to do. )
 * @author Vinson
 * @version 1.0
 */
public class ZKWXTPAuthAccountAccessToken extends ZKWXAbstractAccessToken {
    ...
    public ZKWXTPAuthAccountAccessToken(String thirdPartyAppid, String authorizerAppid) {
        this.identification = ZKWXTPAuthAccountAccessToken.makeIdentification(thirdPartyAppid, authorizerAppid);
