...
public class ZKWXPayService {
    ...
    public ZKWXPlatformCert getPlatformCert(String mchid) throws ParseException, IOException {
        String key = "-default";
        ...
        if (cert == null || cert.isExpiration()) {
            ...
            if (cert == null) {
                if (pCert == null) {
                    ...
                    throw ZKCodeException.as("zk.wechat.000021", "平台证书不存在", null, mchid);
                }
                cert = this.getPlatformCert(pCert);
            }
    ...
    public ZKWXPlatformCert getPlatformCert(String mchid, String serialNo) throws ParseException, IOException {
        ...
        if (cert == null || cert.isExpiration()) {
            ...
            if (cert == null) {
                if (pCert == null) {
                    ...
                    throw ZKCodeException.as("zk.wechat.000022", "平台证书不存在", null, mchid, serialNo);
                }
                cert = this.getPlatformCert(pCert);
            }
    ...
    public ZKWXApiCert getApiCertKey(String mchid) throws FileNotFoundException {
        if (apiCertMap.get(mchid) == null) {
            ...
            if (merchant == null) {
                ...
                throw ZKCodeException.as("zk.wechat.000006", "户号未对接", null, mchid);
            }
    ...
    public boolean checkSign(String mchid, String wechatpaySerial, String wechatpaySignature, String wechatpayTimestamp,
            ...
            String bodyStr) throws ParseException, IOException {
