...
public class ZKWXV3NativeApiOrder {

    ZKPayGetOrder payGetOrder;

    ZKWXGetAmount amount = null;

    private ZKWXV3NativeApiOrder(){

    }

    public static ZKWXV3NativeApiOrder asByZKPayGetOrder(ZKPayGetOrder payGetOrder) {
        ZKWXV3NativeApiOrder apiOrder = new ZKWXV3NativeApiOrder();
