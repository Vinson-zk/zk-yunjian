...
public class ZKMailIndexController extends ZKBaseController {
    ...
    public ZKMsgRes welcome() {
        return ZKMsgRes.asOk("index: " + ZKMsgUtils.getMessage(ZKWebUtils.getLocale(), "zk.mail.msg.welcome") + " "
                + ZKEnvironmentUtils.getString("spring.application.name", "zk mail"));
    }

    @RequestMapping({ "user" })
    public ZKMsgRes user() {
        return ZKMsgRes.asOk("user: " + ZKMsgUtils.getMessage(ZKWebUtils.getLocale(), "zk.mail.msg.welcome") + " "
                + ZKEnvironmentUtils.getString("spring.application.name", "zk mail"));
    }
