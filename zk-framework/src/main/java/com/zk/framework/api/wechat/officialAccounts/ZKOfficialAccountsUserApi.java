...
* @author Vinson 
* @Package com.zk.framework.api.wechat.officialAccounts 
...
* @version 1.0 
*/
@FeignClient(name = YunJian_App.wechat.name, contextId = "com.zk.framework.api.wechat.officialAccounts.ZKOfficialAccountsUserApi")
