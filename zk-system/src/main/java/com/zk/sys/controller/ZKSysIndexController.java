...
public class ZKSysIndexController {
    ...
    public ZKMsgRes welcome() {
        return ZKMsgRes.asOk("index: " + ZKMsgUtils.getMessage(ZKWebUtils.getLocale(), "zk.sys.msg.welcome") + " "
                + ZKEnvironmentUtils.getString("spring.application.name", "zk system"));
    }

    @RequestMapping({ "user" })
    public ZKMsgRes user() {
        return ZKMsgRes.asOk("user: " + ZKMsgUtils.getMessage(ZKWebUtils.getLocale(), "zk.sys.msg.welcome") + " "
                + ZKEnvironmentUtils.getString("spring.application.name", "zk system"));
    }
