...
* with ZK-Vinson. 
*
* @Title: ZKSysJdbcConfiguration.java 
* @author Vinson 
* @Package com.zk.sys.configuration 
* @Description: TODO(simple description this file what to do. ) 
* @date Feb 5, 2023 2:44:11 AM 
* @version V1.0 
*/
package com.zk.sys.configuration;
...
/** 
* @ClassName: ZKSysJdbcConfiguration 
...
public class ZKSysJdbcConfiguration {

    protected static Logger log = LoggerFactory.getLogger(ZKSysJdbcConfiguration.class);
