...
*/
@Configuration
@ImportResource(locations = { "classpath:test_spring_ctx_dynamic_mybatis.xml" })
@PropertySource(encoding = "UTF-8", value = { "classpath:datasource/test_database.properties" })
public class ZKDemoJdbcConfiguration {

    protected Logger log = LoggerFactory.getLogger(getClass());

    @Value("${zk.demo.dynamic.jdbc.username_w}")
    private String dbUserName_w;

    @Value("${zk.demo.dynamic.jdbc.password_w}")
    private String dbPwd_w;

    @Value("${zk.demo.dynamic.jdbc.username_r}")
    private String dbUserName_r;

    @Value("${zk.demo.dynamic.jdbc.password_r}")
...
//    @Primary
    ...
    @ConfigurationProperties(prefix = "zk.demo.dynamic.jdbc.druid.pool")
    ...
    public ZKDynamicDataSource zkDynamicDataSource(ConfigurationPropertiesBindingPostProcessor configurationPropertiesBinder) {
        ...
        System.out.println("[^_^:20210225-1147-001] ====================================================");
        System.out.println("[^_^:20210225-1147-001] 数据库链接：" + dds_w.getUrl());
        System.out.println("[^_^:20210225-1147-001] ====================================================");
