...
public class ZKConfigBeanDefinitionOne implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry,
        ...
        System.out.println(Print.config + "registerBeanDefinitions - 1; " + this.getClass().getSimpleName() + " " + this.hashCode());
        registerBeanDefinitions(importingClassMetadata, registry);
    }

    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        System.out.println(Print.config + "registerBeanDefinitions - 2; " + this.getClass().getSimpleName() + " " + this.hashCode());
    }
