...
//    }
    ...
    // @DependsOn("ZKBeanValue1")
    @Bean
    public ZKBeanValue ZKBeanValue2() {
        return new ZKBeanValue("ZKBeanValue2");
    }

    @ConfigurationProperties(prefix = "zk.bean")
    @Bean
    public ZKBeanValue ZKBeanValue1() {
        return new ZKBeanValue("ZKBeanValue1");
    }
