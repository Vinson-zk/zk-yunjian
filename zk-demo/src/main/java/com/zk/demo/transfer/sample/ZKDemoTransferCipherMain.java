...
public class ZKDemoTransferCipherMain {
    ...
    private static Logger log = LoggerFactory.getLogger(ZKDemoTransferCipherMain.class);
    ...
    public static void testIndex() throws Exception {
        ...
        statusCode = ZKHttpApiUtils.postJson(url + "?" + ZKParamsUtils.convertStringParamter(parameterMap),
                ZKJsonUtils.writeObjectJson(demoEntity), null, headerMap, byteOs, null);
        ...
        /*** 进行加解密 ***/
        String parameterStr = ZKJsonUtils.writeObjectJson(parameterMap);
        String demoEntityStr = ZKJsonUtils.writeObjectJson(demoEntity);
