...
import com.zk.demo.configuration.ZKDemoConfigutation;
...
@ComponentScan( //
        basePackages = { "com.zk.demo.*" }, //
        excludeFilters = { @ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.zk.demo.context.*") } //
)
