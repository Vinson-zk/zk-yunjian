...
* with ZK-Vinson. 
*
* @Title: ZKCoreTestHelperMvcSpringBootMain.java 
* @author Vinson 
...
/** 
* @ClassName: ZKCoreTestHelperMvcSpringBootMain 
* @Description: TODO(simple description this class what to do. ) 
* @author Vinson 
* @version 1.0 
*/
@SpringBootApplication(exclude = { WebMvcAutoConfiguration.class })
@ImportAutoConfiguration(value = { ZKCoreParentConfiguration.class, ZKCoreRedisConfiguration.class,
        ZKCoreChildConfiguration.class, ZKCoreEnvSourceConfiguration.class, ZKCoreEnvParentConfiguration.class,
        ZKCoreEnvChildConfiguration.class })
public class ZKCoreTestHelperMvcSpringBootMain {

    static ConfigurableApplicationContext ctx;

    public static void main(String[] args) {
        System.out.println("[^_^:20210812-1730-001]=========================================================");
        System.out.println("[^_^:20210812-1730-001]=== zk Core ZKCoreTestHelperMvcSpringBootMain 测试启动 ... ...");
        System.out.println("[^_^:20210812-1730-001]=========================================================");
        run(args);
        System.out.println("[^_^:20210812-1730-001]---------------------------------------------------------");
    }
    ...
    public static ConfigurableApplicationContext run(String[] args) {
        ...
        SpringApplicationBuilder appCtxBuilder = new SpringApplicationBuilder(ZKCoreTestHelperMvcSpringBootMain.class);
