 ...
 * with Vinson. 
 *
 * @Title: ZKCoreTransferCipherController.java 
 * @author Vinson 
...
/** 
* @ClassName: ZKCoreTransferCipherController 
* @Description: TODO(simple description this class what to do.) 
* @author Vinson 
* @version 1.0 
*/
@RestController
@RequestMapping("${zk.path.admin:zkTest}/${zk.path.core:cTest}/tc")
public class ZKCoreTransferCipherController {
    /**
     * 测试时的一些参数名称
     */
    ...
    public Map<String, ?> transferCipher(@PathVariable(RequestParams.pn_pathVariable1) String variable1,
        ...
        resMap.put(RequestParams.pn_strs, msg.normal_transferCipher + ZKJsonUtils.writeObjectJson(strs));
        ...
        System.out.println("[^_^:20190625-0903-002] resMap:" + ZKJsonUtils.writeObjectJson(resMap));
    ...
    public Map<String, ?> transferCipherNoReqBody(@PathVariable(RequestParams.pn_pathVariable1) String variable1,
        ...
        resMap.put(RequestParams.pn_strs, msg.normal_transferCipherNoReqBody + ZKJsonUtils.writeObjectJson(strs));
        resMap.put(RequestParams.pn_int, intValue * intValue);
        ...
        System.out.println("[^_^:20190627-0907-002] resMap:" + ZKJsonUtils.writeObjectJson(resMap));
