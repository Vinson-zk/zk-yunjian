...
* with ZK-Vinson. 
*
* @Title: ZKGatewayJdbcConfiguration.java 
* @author Vinson 
...
/**
 * @ClassName: ZKGatewayJdbcConfiguration
...
@PropertySource(encoding = "UTF-8", value = { "classpath:zk.gateway.jdbc.properties" })
public class ZKGatewayJdbcConfiguration {

    protected Logger log = LoggerFactory.getLogger(getClass());

    @Value("${zk.gateway.db.dynamic.jdbc.username_w}")
    private String dbUserName_w;

    @Value("${zk.gateway.db.dynamic.jdbc.password_w}")
    private String dbPwd_w;

    @Value("${zk.gateway.db.dynamic.jdbc.username_r}")
    private String dbUserName_r;

    @Value("${zk.gateway.db.dynamic.jdbc.password_r}")
...
//    @Primary
    ...
    @ConfigurationProperties(prefix = "zk.gateway.db.dynamic.jdbc.druid.pool")
    ...
    public ZKDynamicDataSource zkDynamicDataSource(ConfigurationPropertiesBindingPostProcessor configurationPropertiesBinder) {
        ...
        System.out.println("[^_^:20220615-1101-001] ====================================================");
        System.out.println("[^_^:20220615-1101-001] 数据库链接：" + dds_w.getUrl());
        System.out.println("[^_^:20220615-1101-001] ====================================================");
