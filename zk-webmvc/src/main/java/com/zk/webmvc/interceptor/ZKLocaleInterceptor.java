...
public class ZKLocaleInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest hReq, HttpServletResponse hRes, Object arg) throws Exception {
        ...
        LocaleResolver localeResolver = (LocaleResolver) ZKWebUtils.getLocaleResolver(ZKWebUtils.getAppCxt(), hReq);
        ...
        if (locale != null) {
            ...
            if (localeResolver instanceof ZKLocaleResolver) {
                ZKWebUtils.setLocale(locale, (ZKLocaleResolver) localeResolver, hReq, hRes);
            }
            else {
