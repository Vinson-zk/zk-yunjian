 ...
 * with Vinson. 
 *
 * @Title: ZKBaseHelperControllerTest.java 
 * @author Vinson 
...
/** 
* @ClassName: ZKBaseHelperControllerTest 
...
@TestPropertySource(locations = { "classpath:/" }, properties = { "spring.config.name=test_mongodb" })
public class ZKBaseHelperControllerTest {
...
//            response = testRestTemplate.postForEntity(this.baseUrl + "/base/helper/data", zkBhe, String.class);
            ...
            response = testRestTemplate.getForEntity(
                    this.baseUrl + "/base/helper/data?spareJson={1}&createDate={2}&spare2={3}", String.class,
                    ZKJsonUtils.writeObjectJson(zkJson), "2019-08-15 14:58:46", "v_spare2");
...
//            expectStr = "{\"createDate\":\"2019-08-15 14:58:46\",\"spare2\":\"v_spare2\",\"spareJson\":{\"nInt\":2,\"nArray\":[1,2],\"nString\":\"v_nString\",\"nZKJson\":{\"nInt\":2,\"nArray\":[1,2],\"nString\":\"v_nString\",\"nList\":[\"aaa\"]},\"nList\":[\"aaa\"]},\"delFlag\":0,\"version\":0}";
            ...
            expectStr = ZKJsonUtils.writeObjectJson(zkBhe);
