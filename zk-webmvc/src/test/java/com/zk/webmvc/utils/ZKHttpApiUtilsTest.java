...
public class ZKHttpApiUtilsTest {
    ...
    public void testPostJson() {
        try {
            ...
            System.out.println("[^_^:20230131-0856-001] entity->json: " + ZKJsonUtils.writeObjectJson(entity));
            ...
            resStr = outStringBuffer.toString();
            entity.setRemark(param);
            System.out.println("[^_^:20230131-0857-001] entity->json: " + ZKJsonUtils.writeObjectJson(entity));
