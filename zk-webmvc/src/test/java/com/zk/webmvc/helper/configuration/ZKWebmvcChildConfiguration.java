...
public class ZKWebmvcChildConfiguration {
    ...
    public void dispatcherServletRegistrationBean(DispatcherServletRegistrationBean registration) {
        MultipartConfigElement multipartConfigElement = new MultipartConfigElement("/tmp/spittr/uploads", maxFileSize,
                maxRequestSize, 0);
    ...
    RequestMappingHandlerAdapter requestMappingHandlerAdapter(HttpMessageConverters messageConverters) {
    ...
    SessionLocaleResolver localeResolver() {
        ...
        zkSessionLocaleResolver.setDefaultLocale(
                ZKLocaleUtils.valueOf(env.getProperty("zk.default.locale", String.class, "en_US")));
