...
//    }
    ...
    public FilterRegistrationBean<Filter> zkSecFilter(ZKSecSecurityManager securityManager) throws Exception {
        ...
        zkSecFilterFactoryBean.setLoginUrl("/sec/h/c/login");
        ...
        setFilterChainMap.put("/sec/h/c/none", "anon");
        setFilterChainMap.put("/sec/h/c/login", "login");
        setFilterChainMap.put("/sec/h/c/logout", "logout");
