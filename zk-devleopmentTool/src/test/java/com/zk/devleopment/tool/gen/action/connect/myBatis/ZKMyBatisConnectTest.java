...
public class ZKMyBatisConnectTest {
    ...
    public void testGetColumnSourceList() {
        try {
            ...
            System.out.println("[^_^:20170529-2114-001] pkList.0=" + ZKJsonUtils.writeObjectJson(colList.get(0)));
    ...
    public void testGetPkSourceList() {
        try {
            ...
            System.out.println("[^_^:20170529-2114-002] pkList=" + ZKJsonUtils.writeObjectJson(pkList));
