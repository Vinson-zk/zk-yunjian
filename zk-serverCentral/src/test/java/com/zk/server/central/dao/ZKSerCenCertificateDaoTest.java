...
public class ZKSerCenCertificateDaoTest {
    ...
    public void testDML() {
        ...
        try {
            ...
            System.out
                    .println("[^_^:20190825-1350-001] zkScResultList: " + ZKJsonUtils.writeObjectJson(zkScResultList));
...
//                    ZKDateUtils.parseDate("2019-09-10", ZKDateUtils.DF_yyyy_MM_dd));
            ...
            System.out
                    .println("[^_^:20190825-1350-002] zkScResultList: " + ZKJsonUtils.writeObjectJson(zkScResultList));
            ...
            zkScResultList = dao.findList(zkScResult);
            System.out
                    .println("[^_^:20190825-1350-003] zkScResultList: " + ZKJsonUtils.writeObjectJson(zkScResultList));
