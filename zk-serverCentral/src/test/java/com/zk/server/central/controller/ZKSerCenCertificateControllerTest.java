...
//                    ZKJsonUtils.writeObjectJson(serverCertificateMap).getBytes());
...
//            response = testRestTemplate.postForEntity(baseUrl + "/sc", entityBuilder.build(), ZKMsgRes.class);
            ...
            zkMsgRes = ZKJsonUtils.jsonStrToObject(response.getBody(), ZKMsgRes.class);
...
//            response = testRestTemplate.postForEntity(baseUrl + "/sc", entityBuilder.build(), ZKMsgRes.class);
    ...
    private ZKSerCenCertificate insert(int i, String spare1) {
        ...
        zkSc = ZKJsonUtils.jsonStrToObject(zkMsgRes.getDataStr(), ZKSerCenCertificate.class);
    ...
    public void testScGet() {
        ...
        try {
            ...
            zkScGet = ZKJsonUtils.jsonStrToObject(zkMsgRes.getDataStr(), ZKSerCenCertificate.class);
...
//            count = 3;
            ...
            zkScPage = ZKJsonUtils.jsonStrToObject(zkMsgRes.getDataStr(), ZKPage.class);
//            zkScPage = ZKJsonUtils.jsonStrToObject(zkMsgRes.getDataStr(), ZKPage.class, false);
