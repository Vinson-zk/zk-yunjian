<h1 class="zk-eureka-font-h1">System Status</h1>
<div class="row">
  <div class="col-md-6">
    <table id='instances' class="table table-condensed table-striped table-hover zk-eureka-font">
      <#if amazonInfo??>
        <tr>
          <td>EUREKA SERVER</td>
          <td>AMI: ${amiId!}</td>
...
<h1 class="zk-eureka-font-h1">DS Replicas</h1>
<ul class="list-group">
