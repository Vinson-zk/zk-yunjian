...
//    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ...
    public String defaultException(Exception e) {
        System.out.println("[>_<:20190826-1150-001] default exception: " + ZKJsonUtils.writeObjectJson(e));
...
//    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ...
    public ModelAndView MissingResourceException(MissingResourceException errMsg) {
        ...
        System.out.println("[>_<:20190826-1150-002] missingResource exception: " + ZKJsonUtils.writeObjectJson(errMsg));
