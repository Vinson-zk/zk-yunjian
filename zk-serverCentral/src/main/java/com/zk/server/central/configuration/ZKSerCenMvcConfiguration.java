...
public class ZKSerCenMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        System.out.println("[^_^:20230129-1648-002] --- [" + this.getClass().getSimpleName() + "] 配置 zk mvc 日志拦截器；" + this);
...
//    }
    ...
    // 异常处理
    @Bean
    public ZKViewExceptionHandlerResolver viewExceptionHandlerResolver() {
