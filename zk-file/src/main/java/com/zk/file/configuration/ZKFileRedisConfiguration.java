...
public class ZKFileRedisConfiguration {
    ...
    public JedisPool jedisPool(JedisPoolConfig jedisPoolConfig) {
        ...
        logger.info("[^_^:20220621-1255-001] ====================================================");
        logger.info("[^_^:20220621-1255-001] === Redis 连接信息 =======================================");
        logger.info("[^_^:20220621-1255-001] ====================================================");
        logger.info("[^_^:20220621-1255-001] hosr:{}, port:{}, password:{}", host, port, password);
        logger.info("[^_^:20220621-1255-001] JedisPoolConfig:{}", ZKJsonUtils.writeObjectJson(jedisPoolConfig));
        logger.info("[^_^:20220621-1255-001] ====================================================");
