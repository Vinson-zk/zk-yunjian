...
public class ZKFileIndexController {
    ...
    public ZKMsgRes index() {
        return ZKMsgRes.asOk("index: " + ZKMsgUtils.getMessage(ZKWebUtils.getLocale(), "zk.file.msg.welcome") + " "
                + ZKEnvironmentUtils.getString("spring.application.name", "zk file"));
    }

    @RequestMapping("user")
    public ZKMsgRes user() {
        return ZKMsgRes.asOk("user: " + ZKMsgUtils.getMessage(ZKWebUtils.getLocale(), "zk.file.msg.welcome") + " "
                + ZKEnvironmentUtils.getString("spring.application.name", "zk file"));
    }
