...
public class ZKCookieUtils {
    ...
    private final static Logger logger = LoggerFactory.getLogger(ZKCookieUtils.class);
...
//    }
    ...
    public static String getCookieValueByRequest(String cookieName) {
        return getCookieValueByRequest(ZKWebUtils.getRequest(), cookieName);
    }

    public static Cookie getCookieByRequest(String cookieName) {
        return getCookieByRequest(ZKWebUtils.getRequest(), cookieName);
    }
    ...
    public static String getCookieValueByRequest(HttpServletRequest request, String cookieName) {
        ...
        if (c == null) {
            logger.error("[>_<:20191220-1051-003] 从 HttpServletRequest 中取 cookie:{} 为 null；cookieName：{}", cookieName);
            return null;
        }
        return c.getValue();
    }
    ...
    public static Cookie getCookieByRequest(HttpServletRequest request, String cookieName) {
        ...
        return getCookie(cookies, cookieName, request.getRequestURI());
    }

    /*** 从响应头中，取 cookie 信息 ********************************************/
    public static String getCookieValueByResponse(String cookieName) {
        Cookie c = getCookieByResponse(ZKWebUtils.getResponse(), cookieName);
        if (c == null) {
            logger.error("[>_<:20191220-1051-004] 从 HttpServletResponse 中取 cookie:{} 为 null；cookieName：{}", cookieName);
            return null;
        }
        return c.getValue();
    }
    ...
    public static Cookie getCookieByResponse(String cookieName) {
        return getCookieByResponse(ZKWebUtils.getResponse(), cookieName);
    }
    ...
    public static Cookie[] getCookieByResponse(HttpServletResponse response) {
        ...
        return parseCookieStrs(cookieStrList);
    }
