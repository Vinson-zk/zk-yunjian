 ...
 * with Vinson. 
 *
 * @Title: ZKOriginTrackedPropertiesLoader.java 
 * @author Vinson 
 * @Package com.zk.core.commons 
 * @Description: TODO(simple description this file what to do.) 
 * @date Dec 18, 2019 2:27:18 PM 
 * @version V1.0   
*/
package com.zk.core.commons;
 ...
 * 
 * @ClassName: ZKOriginTrackedPropertiesLoader
 * @Description: TODO(simple description this class what to do.)
 * @author Vinson
 * @version 1.0
 */
public class ZKOriginTrackedPropertiesLoader {
     ...
     * 
     * @param expandLists
     *            if list {@code name[]=a,b,c} shortcuts should be expanded
     * @return the loaded properties
     * @throws IOException
     *             on read error
     */
