...
public enum ZKFileType {
    ...
    _3GP2("3g2", "0000002066747970336770"), _3GP4("3g4", "0000001866747970336770"), AMR_NB("amr", "2321414D52"), // Adaptive Multi-Rate ACELP (Algebraic Code Excited Linear Prediction) Codec, commonly audio format with GSM cell phones
    AMR_WB("amr", "2321414D522D5742"), JPG("jpg", "FFD8FF"), // JPEG(jpg)
    ...
    ZIP("zip", "504B0304"), XML("xml", "3C3F786D6C"), RAR("rar", "52617221"), XLS("xls", "D0CF11E0"), // MSWord
    ...
    EPS("eps", "252150532D41646F6265"), PS("ps", "252150532D41646F6265"), QDF("qdf", "AC9EBD8F"), // Quicken(qdf)
