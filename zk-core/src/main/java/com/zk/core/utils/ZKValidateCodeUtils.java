...
public class ZKValidateCodeUtils {
    ...
    protected static Logger logger = LoggerFactory.getLogger(ZKValidateCodeUtils.class);
    ...
    public static class ZKImgUtils {
        ...
        protected static Logger logger = LoggerFactory.getLogger(ZKImgUtils.class);
