...
public class ZKDateUtilsTest {
    ...
    public void testGetDayOfWeek() {
        try {
            ...
            TestCase.assertEquals("2016-02-28", ZKDateUtils.formatDate(resultDate, ZKDateUtils.DF_yyyy_MM_dd));
            ...
            TestCase.assertEquals("2016-03-02", ZKDateUtils.formatDate(resultDate, ZKDateUtils.DF_yyyy_MM_dd));

            resultDate = ZKDateUtils.getDayOfWeek(date, 6);
            TestCase.assertEquals("2016-03-05", ZKDateUtils.formatDate(resultDate, ZKDateUtils.DF_yyyy_MM_dd));

            resultDate = ZKDateUtils.getDayOfWeek(date, 8);
            TestCase.assertEquals("2016-02-29", ZKDateUtils.formatDate(resultDate, ZKDateUtils.DF_yyyy_MM_dd));
    ...
    public void testGetFirstDateOfWeek() {
        try {
            ...
            TestCase.assertEquals("2016-02-28 11:26:28.000316",
    ...
    public void testGetLastDateOfWeek() {
        try {
            ...
            TestCase.assertEquals("2016-03-05 11:26:28.000316",
                    ZKDateUtils.formatDate(resultDate, ZKDateUtils.DF_yyyy_MM_dd_HH_mm_ss_SSSSSS));
