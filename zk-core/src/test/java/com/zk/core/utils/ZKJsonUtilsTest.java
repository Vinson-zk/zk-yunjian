...
public class ZKJsonUtilsTest {
    ...
    public void testJsonStrToList() {
        try {
            ...
            List<Map<String, Object>> resultList = ZKJsonUtils.jsonStrToList(str);
    ...
    public void testJsonStrToMap() {
        try {
            ...
            Map<?, ?> map = ZKJsonUtils.jsonStrToMap(str);
    ...
    public void testWriteObjectJson() {
        try {
            ...
            String resultStr = ZKJsonUtils.writeObjectJson(list);
            System.out.println(resultStr);

            resultStr = ZKJsonUtils.writeObjectJson(1);
            System.out.println(resultStr);
        }
        catch(Exception e) {
            e.printStackTrace();
