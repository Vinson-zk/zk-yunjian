...
* with ZK-Vinson. 
*
* @Title: ZKSecHttpServletResponse.java 
* @author Vinson 
...
/** 
* @ClassName: ZKSecHttpServletResponse 
* @Description: TODO(simple description this class what to do. ) 
* @author Vinson 
* @version 1.0 
*/
public class ZKSecHttpServletResponse extends HttpServletResponseWrapper {

    public ZKSecHttpServletResponse(HttpServletResponse response) {
        super(response);
    }
    ...
    private ZKSecHttpServletRequest request = null;

    private boolean traceTicketId = false;

    public ZKSecHttpServletResponse(HttpServletResponse wrapped, ServletContext context,
            ZKSecHttpServletRequest request, boolean traceTicketId) {
        super(wrapped);
    ...
    public ZKSecHttpServletRequest getRequest() {
        return request;
    }

    public void setRequest(ZKSecHttpServletRequest request) {
        this.request = request;
    }
