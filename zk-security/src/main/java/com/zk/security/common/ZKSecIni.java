...
* @version 1.0 
*/
public class ZKSecIni implements Map<String, ZKSecIni.Section> {

    private static transient final Logger log = LoggerFactory.getLogger(ZKSecIni.class);
     ...
     */
    public ZKSecIni(ZKSecIni defaults) {
        this();
        if (defaults == null) {
    ...
    private static String cleanName(String sectionName) {
        String name = ZKStringUtils.clean(sectionName);
        if (name == null) {
     ...
     * {@code sectionName}. If the section does not yet exist, it will be
     * created. If the {@code sectionName} is null or empty, the name/value pair
     * will be placed in the default (unnamed, empty string) section.
     *
     * @param sectionName
...
//     */
//    public static Ini fromResourcePath(String resourcePath) throws SecurityException {
...
//     */
//    public void loadFromPath(String resourcePath) throws SecurityException {
//        InputStream is;
//        try {
...
//    }
     ...
     */
    public void load(String iniConfig) throws ZKSecUnknownException {
...
//     */
//    public void load(InputStream is) throws SecurityException {
//        if (is == null) {
...
//    }
    ...
    private void addSection(String name, StringBuilder content) {
        if (content.length() > 0) {
            ...
            String cleaned = ZKStringUtils.clean(contentString);
            if (cleaned != null) {
    ...
    public void load(Scanner scanner) {
        ...
        while (scanner.hasNextLine()) {
            ...
            String line = ZKStringUtils.clean(rawLine);
    ...
    protected static boolean isSectionHeader(String line) {
        String s = ZKStringUtils.clean(line);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ZKSecIni) {
            ZKSecIni ini = (ZKSecIni) obj;
    ...
    public String toString() {
        if (ZKCollectionUtils.isEmpty(this.sections)) {
            return "<empty INI>";
        }
        else {
            StringBuilder sb = new StringBuilder("sections=");
            int i = 0;
            for (ZKSecIni.Section section : this.sections.values()) {
                if (i > 0) {
                    sb.append(",");
                }
    ...
    public static class Section implements Map<String, String> {
        ...
        private Section(String name, String sectionContent) {
            ...
            if (ZKStringUtils.hasText(sectionContent)) {
        ...
        protected static String[] splitKeyValue(String keyValueLine) {
            String line = ZKStringUtils.clean(keyValueLine);
            if (line == null) {
                return null;
            }
            ...
            String key = ZKStringUtils.clean(keyBuffer.toString());
            String value = ZKStringUtils.clean(valueBuffer.toString());
        ...
        private static Map<String, String> toMapProps(String content) {
            ...
            while (scanner.hasNextLine()) {
                line = ZKStringUtils.clean(scanner.nextLine());
                if (isContinued(line)) {
