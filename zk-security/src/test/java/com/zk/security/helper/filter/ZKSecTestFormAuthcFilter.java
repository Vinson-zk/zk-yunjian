...
* with ZK-Vinson. 
*
* @Title: ZKFormAuthcFilter.java 
* @author Vinson 
* @Package com.zk.security.helper.filter 
* @Description: TODO(simple description this file what to do. ) 
* @date Jul 5, 2021 6:08:04 PM 
* @version V1.0 
*/
package com.zk.security.helper.filter;
...
/** 
* @ClassName: ZKFormAuthcFilter 
* @Description: TODO(simple description this class what to do. ) 
* @author Vinson 
* @version 1.0 
*/
public class ZKSecTestFormAuthcFilter extends FormAuthenticationFilter {
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        this.setUsernameParam(ZKSecConstants.PARAM_NAME.Username);
        this.setPasswordParam(ZKSecConstants.PARAM_NAME.Pwd);
