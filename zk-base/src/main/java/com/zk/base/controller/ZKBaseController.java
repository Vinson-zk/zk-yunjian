...
//    protected S service;
    ...
    protected String renderString(HttpServletResponse response, Object object) {
        return renderString(response, ZKJsonUtils.writeObjectJson(object), "application/json");
    }
    ...
    /*******************************************************************/
    /*** 异常 绑定；注：设置异常处理适配器 exceptionHandlerResolver 后，这些绑定就不生效了； */
    /*******************************************************************/
     ...
     * @Description: TODO(simple description this method what to do.)
     * @author Vinson
     * @date Aug 21, 2020 11:11:56 AM
     * @param codeE
     * @return
     * @return String
     */
    @ExceptionHandler({ ZKCodeException.class })
    public String bindException(ZKCodeException codeE) {
     ...
     * @return String
     */
    @ExceptionHandler({ ZKMsgException.class })
    public String bindException(ZKMsgException msgE) {
